...
export class GroupService {
    ...
    async getGroupInfo(group_uuid: string): Promise<Group> {
        ...
        return await this.groupRepository.findOne({ where: { group_uuid: group_uuid }, relations: { users: true } })
    ...
    async joinGroup(user_uuid: string, group_uuid: string, join_code: string) {
